...
const projectsData = [
    ...
    { id: 2, name: "Recipe Finder", description: "Discover and organize recipes tailored to your preferences and dietary needs", 
    ...
    { id: 3, name: "Travel Journal", description: "Travel journal of my trips while studying abroad.", longDesc: "This was my first solo React project, and a great way to compile my favorite memories and images from when I was abroad.", 
        skills: ["React", "Javascript", "CSS"], imageUrl: getImageURl("projects/travelJournal.png"), sourceCode: "https://v2.scrimba.com/s005kmodh3" },
    { id: 4, name: "Unplugged", description: "An app that helps you ~unplug~ from social media.", longDesc: "Unplugged is an app designed to help users discover engaging activities in their area, encouraging them to take a break from screens and connect with the world around them.", 
